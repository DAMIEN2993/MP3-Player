...
#Function
def play_song():
	filename = filedialog.askopenfilename(initialdir='/home/arbi/Music', title='Please select a file')
	...
	try:
		...
		mixer.music.play()
		song_title_label.config(fg='green', text='Now playong: ' + str(song_title))
...
Label(master, text='Please select a music track you would like to play', font=('Calibri', 12), fg='seagreen').grid(sticky='N', row=1)
